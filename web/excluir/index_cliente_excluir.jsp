<%-- 
    Document   : index_cliente_excluir
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                <div class="top-navbar">
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            <h4 class="page-title">Excluir Cliente [CPF]</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">JBM</a></li>
                                <li class="breadcrumb-item active" aria-curent="page">Excluir CLIENTE [CPF]</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                <br>
                <div class="container ">
                    <form name="frmConsCliente" action="cliente_excluir.jsp" method="post">
                        <div class="mb-3">
                        ...
                        <div class="text-center">
                            ...
                            <button type="submit" class="btn btn-primary custom-button">Excluir</button>
