<%-- 
    Document   : consulta_venda_periodo
    Created on : 17 de nov. de 2023, 11:07:31
...
<html lang="pt-br">
    <head>
        ...
        <title>Consulta Vendas JBM</title>
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                <div class="top-navbar">
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            <h4 class="page-title">Consulta Vendas [Período]</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">JBM</a></li>
                                <li class="breadcrumb-item active" aria-curent="page">Consulta Vendas [Período]</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                <br>
                <div class="container">
                    <form name="frmConsVendas" action="" method="post">
                        <div class="row">
                            <div  class="col-md-6">
                    ...
                    <%
                        try {
                            ...
                            // Verificar se as datas não são nulas ou vazias
                            if (dataInicialStr != null && dataFinalStr != null && !dataInicialStr.isEmpty() && !dataFinalStr.isEmpty()) {
                                ...
                                // Chamar o método consultarVendasPorPeriodo do VendaDAO
                    ...
                    <table border="1">
                        ...
                        <tbody>
                            <%
                                ...
                                for (Vendas venda : vendasNoPeriodo) {
                                    String dataFormatada = venda.getDataVenda().format(formatter);
                            %>
                            <tr>
                                <td><%= dataFormatada%></td>
                                <td><%= formatarDinheiro(venda.getValorTotal())%></td>
                            </tr>
                            <%
                                    valorTotalPeriodo += venda.getValorTotal();
                                }
                            %>
                        </tbody>
                    </table>
                    ...
                    <%
                                ...
                                out.println("Insira as datas.");
                            }
                        } catch (Exception e) {
                            out.println("Erro ao processar as datas. Erro: " + e.getMessage());
                            e.printStackTrace();
                        }
                    %>
                    <br><br><br><br><br>
