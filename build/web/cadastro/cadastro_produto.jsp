<%-- 
    ...
    Created on : 8 de nov. de 2023, 13:48:56
...
<html lang="pt-br">
    <head>
        ...
        <title>Cadastro Mercadoria JBM</title>
    ...
    <body>
        <div class="wrapper">
                ...
                <ul class="list-unstyled component m-0">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="collapse list-unstyled menu" id="homeSubmenu4">
                            <li><a href="cadastro_produto.jsp"><i class="material-icons">add</i>Cadastrar Mercadoria</a></li>
            ...
            <div id="content">
                <div class="top-navbar">
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            <h4 class="page-title">Cadastro Mercadoria</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">JBM</a></li>
                                <li class="breadcrumb-item active" aria-curent="page">CADASTRO MERCADORIA</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                ...
                <div class="container ">
                    <form name="frmCadProduto" action="processar_cadastro_produto.jsp" method="post">
                        <div class="row">
                            <!-- Campo Código Interno PrimaryKEY -->
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <label for="codigoean" class="form-label">Código EAN:</label>
                                <input type="text" class="form-control" onblur="validarEAN(this)" name="codigoean" id="codigoean" placeholder="Digite o Código EAN" required>
                            </div>
                            <!-- Campo Descrição-->
                            <div class="col-md-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="preco" id="preco" placeholder="00.00" pattern="^\d+(\.\d{1,2})?$">
                                </div>
                            </div>
                            <!-- Campo Quantidade do estoque -->
                            <div class="col-md-3">
                                <label for="qtd_estoque" class="form-label">Quantidade Estoque</label>
                                <input type="number" class="form-control" name="qtd_estoque" id="qtd_estoque">
                            </div>
                        </div>               
        ...
        <script type="text/javascript">
            function validarEAN(input) {
                var codigoEAN = input.value.replace(/\D/g, ''); // Remover caracteres não numéricos

                if (codigoEAN.length !== 13) {
                    alert("O Código EAN deve ter 13 dígitos.");
                }
            }
