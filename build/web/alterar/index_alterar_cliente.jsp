    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content">
                <div class="top-navbar">
                    <div class="xd-topbar">
                        ...
                        <div class="xp-breadcrumbbar text-center">
                            <h4 class="page-title">Alterar Cliente [CPF]</h4>
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">JBM</a></li>
                                <li class="breadcrumb-item active" aria-curent="page">Alterar CLIENTE [CPF]</li>
                            </ol>
                        </div>				 		 
                    </div>
                </div>
                <br>
                <div class="container ">
                    <form name="frmConsCliente" action="alterar_cliente.jsp" method="post">
                        <div class="mb-3">
