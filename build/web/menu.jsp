                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="vendas" href="consultar/consulta_venda_periodo.jsp" >VENDAS &#128178</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="pessoas" href="cadastro/cadastro_cliente.jsp">PESSOAS &#128101</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="caixa" href="abrir_pdv.jsp">CAIXA &#128181</a>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="item gray-background">
                                <a id="produto" href="consultar/produto_consulta_geral.jsp">PRODUTO &#128230</a>
                            </div>
                        </div>
                    </div>
                    <br>
